  ...
  const buttonText = formType === "SIGN_IN" ? "Sign In" : "Sign Up"
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="mt-10 space-y-6">
        ...
        <Button disabled={form.formState.isSubmitting} className='primary-gradient paragraph-medium min-h-12 w-full rounded-2 px-4 py-3 font-inter text-light-900 cursor-pointer'>
        ...
        : <p>
          Alredy have an account?{' '}<Link href={ROUTES.SIGN_IN} className='paragraph-semibold primary-text-gradient'>Sign In</Link>
          </p>}
      </form>
    </Form>
  )
